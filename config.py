...
def args_parser():
    ...
    parser.add_argument('--max_gens',  type=int,   default=50,     help="SOP: 100, MOP: 50")
    parser.add_argument('--num_users', type=int,   default=10,     help="number of users: K")
    parser.add_argument('--frac',      type=float, default=0.9,    help="the fraction: λ")
    ...
    parser.add_argument('--pf',        type=float, default=0.03,   help="failure prob")
    ...
    parser.add_argument('--func',  type=str,   default='dtlz5',     help='test function name')
    parser.add_argument('--d',     type=int,   default=10,          help='dimension of decision space')
    parser.add_argument('--M',     type=int,   default=3,           help="how many objectives")
